package bitc.full502.outsidedir.util;

import org.springframework.scheduling.annotation.EnableScheduling;
import org.springframework.scheduling.annotation.Scheduled;
import org.springframework.stereotype.Component;

//  @EnableScheduling : 스프링 프레임워크에서 지정한 형식대로 스케줄링을 하기 위한 어노테이션
//  많은 개수의 스케줄링이 필요한 경우 SchedulingConfigurer 를 상속받아 Thread pool 을 사용해야 함

//  @Scheduled(스케줄 옵션) : 반복 동작할 스케줄 시간을 지정하기 위한 어노테이션
...
//  * * * * * * : 매번 초 마다 동작
//  */10 * * * * * : 10초 마다 동작
//  30 * * * * * : 매번 분의 30초 정각마다 동작
//  * */10 * * * * : 매번 10분 마다 동작
//  * 10 * * * * : 매번 시간의 10분 정각마다 동작
...
public class MySchedule {
  ...
  public void scheduleFixedRate() {
    System.out.println("rateCount : " + reteCount + ", 스레드 : " + Thread.currentThread().getName());
    reteCount++;
  }
}
